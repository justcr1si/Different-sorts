...
def count_dynasty_experience(spaceman: Spaceman) -> int:
    ...
    while stack:
        current_spaceman = stack.pop()
        total_experience += current_spaceman.space_experience

        if current_spaceman.father:
            stack.append(current_spaceman.father)
        if current_spaceman.mother:
            stack.append(current_spaceman.mother)
